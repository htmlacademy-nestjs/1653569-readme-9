...
function getConfig(): NotifyConfig {
  const config: NotifyConfig = {
    ...
    rabbit: {
      ...
      port: parseInt(process.env.RABBIT_PORT ?? DEFAULT_RABBIT_PORT.toString(), DECIMAL_RADIX),
    ...
    mail: {
      ...
      port: parseInt(process.env.MAIL_SMTP_PORT ?? DEFAULT_SMTP_PORT.toString(), DECIMAL_RADIX),
